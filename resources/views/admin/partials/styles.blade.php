@php /* admin shared styles (extracted from layouts/app.blade.php) */ @endphp
<style>
:root{
  --navy-900:#0B1F3A;
  --navy-800:#0E2647;
...
.crud-form{max-width:760px}
.form-actions{display:flex;gap:10px;margin-top:18px}
.empty-cell{text-align:center;color:var(--text-secondary);padding:26px}
.topbar-right{display:flex;align-items:center;gap:14px}
.topbar-user{font-weight:600;font-size:13px}
.nav-item{display:flex;align-items:center;gap:10px;padding:9px 12px;border-radius:10px;color:var(--text-secondary);text-decoration:none;font-size:13.5px;font-weight:500}
.nav-item:hover{background:var(--bg-hover);color:var(--text-primary)}
.sidebar-nav{padding:10px 12px;display:flex;flex-direction:column;gap:2px}
.nav-group{font-size:10.5px;letter-spacing:.08em;text-transform:uppercase;color:var(--text-tertiary);padding:14px 12px 4px;font-weight:700}
</style>
</style>
