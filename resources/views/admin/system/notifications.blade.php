...
@section('title', 'Notifications — FeedTan Admin Dashboard')
            ...
            <nav class="p-4 h-[calc(100vh-88px)] overflow-y-auto">
                ...
                <div class="mt-8 pt-8 border-t border-slate-700">
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="/admin/notifications" class="flex items-center gap-3 px-4 py-3 bg-slate-700 text-white rounded-lg"><i class="ph ph-bell text-xl"></i><span>Notifications</span></a></li>
        ...
        <div class="flex-1 lg:ml-64">
                ...
                <div class="max-w-full px-4 sm:px-6 py-4">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            ...
                            <h2 class="text-lg sm:text-xl font-semibold text-white">Notification Management</h2>
                        </div>
            ...
            <main class="pt-16 sm:pt-20 p-4 sm:p-6">
                <div class="text-center py-20">
                    <i class="ph ph-bell text-6xl text-slate-300 mb-4"></i>
                    <h3 class="text-xl font-bold text-slate-900 mb-2">Notification Management</h3>
                    <p class="text-slate-500">Manage system notifications and alerts</p>
                </div>
            </main>
