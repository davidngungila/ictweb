...
<nav>
  <a href="{{ route('home') }}" class="nav-logo">
    <img src="{{ asset('jezdan-logo.png') }}" alt="Jezdan Technology" style="height: 60px; width: auto; background: white; border-radius: 8px; padding: 5px;">
  </a>
  ...
  <div class="footer-top">
    <div class="footer-brand">
      <a href="{{ route('home') }}" style="margin-bottom: 15px; display: inline-block;">
        <img src="{{ asset('jezdan-logo.png') }}" alt="Jezdan Technology" style="height: 70px; width: auto; background: white; border-radius: 8px; padding: 5px;">
      </a>
