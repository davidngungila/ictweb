...
@php
  $leadership = [
      [
          ...
          'bio' => 'Oversees the day-to-day operations of the company and monitors the performance of all departments.',
          'linkedin' => '#',
      ...
      [
          ...
          'bio' => 'Manages finance, budgeting, accounting, financial reporting, taxation and financial controls.',
          'linkedin' => '#',
          'email' => 'mailto:info@jezdantech.com',
      ],
      [
          ...
          'bio' => 'Leads technology, software development, IT infrastructure, cybersecurity and digital transformation.',
          'linkedin' => '#',
          'email' => 'mailto:info@jezdantech.com',
      ],
      [
          ...
          'bio' => 'Drives marketing, branding, advertising, social media and public relations.',
          'linkedin' => '#',
          'email' => 'mailto:info@jezdantech.com',
      ],
      [
          ...
          'bio' => 'Leads business development, sales, partnerships, tenders and client acquisition.',
          'linkedin' => '#',
          'email' => 'mailto:info@jezdantech.com',
      ],
  ];
