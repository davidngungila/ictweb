...
<section class="relative bg-gradient-to-br from-purple-900 via-purple-800 to-purple-900 text-white py-20 overflow-hidden">
    ...
    <div class="absolute inset-0">
        <img src="https://res.cloudinary.com/dtxdrmjlk/image/upload/v1774600083/network-switch-with-cables_btxlxw.jpg" alt="Network Installation" class="w-full h-full object-cover opacity-40">
    </div>
